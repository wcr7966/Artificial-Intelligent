...
public class OthelloState implements State {
	...
	private float pieceDifferential() {
		...
		for (short line : hBoard) {
		    difference += pointTable[line + 32768];
		    System.out.print("pointTable " + pointTable[line + 32768] + '\n');
        }
		return difference;
	}
	...
	/**
	 * Get the difference between the number of sides player 1 and player 2 occupy.
	 * @return The aforementioned difference.
	 */
