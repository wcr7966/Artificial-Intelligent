...
public class SingleTreeNode
{
    ...
    public void mctsSearch(ElapsedCpuTimer elapsedTimer) { // elapsedTimer计算一次动作可用的时间
        ...
        while(remaining > 2*avgTimeTaken && remaining > remainingLimit){ // 循环快要超时
    ...
    public SingleTreeNode treePolicy(StateObservation state) { //如果没有完全扩展，则从子节点中找一个，如果已经完全扩展则用uct计算
