...
public class Recorder {
    ...
    public static double[] featureExtract(StateObservation obs){
        ...
        double[] feature = new double[458];  // 448 + 4 + 1(class)
    ...
    public static Instances datasetHeader(){
        ...
        att = new Attribute("Dx"); attInfo.addElement(att);
        att = new Attribute("Firstx"); attInfo.addElement(att);
        att = new Attribute("Firsty"); attInfo.addElement(att);
        //class
