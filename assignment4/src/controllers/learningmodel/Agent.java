...
public class Agent extends AbstractPlayer {
    ...
    public Types.ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
        ...
        // System.out.println("====================");
        // System.out.println(stateObs.getAvatarPosition().x);
        // System.out.println("\n");
        // System.out.println(stateObs.getAvatarPosition().y);
        // System.out.println("\n");
        return bestAction;
    }
    ...
    private Instances simulate(StateObservation stateObs, StateHeuristic heuristic, QPolicy policy) {
        ...
        for (; depth < SIMULATION_DEPTH; depth++) {
            try {
                ...
                int action_num = policy.getAction(features); //best
                ...
                double delta_score = factor * (score_after - score_before); // Qmax
